/* calculated using http://www.stjarnhimlen.se/comp/ppcomp.html (got to 5b)*/
...
****************************************************************************************/
	...
	this.items = {
		"Sun": {name: "Sun", types: ["sun", "star"], body: this.body([0,0],[0,0],[282.9404,4.70935E-5],[1,0],[0.016709,-1.151E-9],[356.0470,0.9856002585])},
		"Moon": {name: "Moon", types: ["natural", "satellite", "moon"], body: this.body([125.1228,-0.0529538083],[5.1454,0],[318.0634,0.1643573223],[60.2666,0],[0.054900,0],[115.3654,13.0649929509])},
		"Mercury": {name: "Mercury", types: ["planet"], body: this.body([48.3313,3.24587E-5],[7.0047,5.00E-8],[29.1241,1.01444E-5],[0.387098,0],[0.205635,5.59E-10],[168.6562,4.0923344368])},
